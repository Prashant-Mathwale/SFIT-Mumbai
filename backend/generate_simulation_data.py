...
def generate_row(i):
    ...
    return {
        ...
        # display metadata
        "expected_risk_profile":         risk_profile.upper(),
    }
...
if __name__ == "__main__":
    ...
    print("  Generating 1000 rows of UNSEEN customer data")
    print("=" * 55)
    ...
    print(df["expected_risk_profile"].value_counts().to_string())
    print(f"\n- Feature columns: {[c for c in df.columns if c not in ['customer_id','name','city','customer_segment_name','expected_risk_profile']]}")
